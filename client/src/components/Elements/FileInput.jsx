...
import BgUpload from "../../assets/bgupload.png";
...
const FileInput = ({ field, form: { touched, erros }, ...props }) => {
  ...
  return (
    <div className="ml-10 w-72 mt-8">
      {/* <h2 className="mb-1 text-slate-700 font-medium">Select your recipe image</h2> */}
      {/* <input {...field} {...props} type="file" /> */}
      <div
        className="relative h-[200px]"
        style={{ backgroundImage: `url(${background ? background : BgUpload})`, backgroundSize: "cover", backgroundPosition: "center", borderRadius: "10px" }}
      >
        {!background && (
          <span className="text-white px-2 py-1 bg-opacity-40 rounded-[2px] font-bold absolute left-[80px] bg-black top-[70px]">Add recipe image</span>
        )}
