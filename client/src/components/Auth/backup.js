...
const Auth = () => {
  ...
  return (
    <>
          ...
          <div className="ml-[500px] w-[300px]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-y-2" autoComplete="off">
              ...
              <div className="flex gap-x-2 text-slate-700 items-center mt-2">
                <p className="text-opacity-30">{isRegistered ? "Doesn't have an acount?" : "Already have an account?"}</p>
      ...
      {isLoading && <AuthLoader message={isRegistered ? "Logging in your account..." : "Creating your account..."} />}
    </>
  );
};
